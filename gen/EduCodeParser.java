...
public class EduCodeParser extends Parser {
	...
	public static final int
		...
		NUMLITERAL=40, COORDLIT=41, StringLiteral=42, UnterminatedStringLiteral=43, 
		IDENT=44, LPAREN=45, RPAREN=46, WHITESPACE=47, LINECOMMENT=48;
	public static final int
		...
		RULE_ret = 9, RULE_loopstmt = 10, RULE_ifstmt = 11, RULE_dcl = 12, RULE_assign = 13, 
		RULE_expr = 14, RULE_logicexpr = 15, RULE_orexpr = 16, RULE_andexpr = 17, 
		RULE_eqexpr = 18, RULE_relexpr = 19, RULE_boollit = 20, RULE_aritexpr = 21, 
		RULE_term = 22, RULE_factor = 23, RULE_dataType = 24, RULE_literal = 25, 
		RULE_eol = 26, RULE_ident = 27, RULE_identname = 28;
	public static final String[] ruleNames = {
		"program", "methods", "method", "methodc", "args", "params", "param", 
		"stmts", "stmt", "ret", "loopstmt", "ifstmt", "dcl", "assign", "expr", 
		"logicexpr", "orexpr", "andexpr", "eqexpr", "relexpr", "boollit", "aritexpr", 
	...
	private static final String[] _SYMBOLIC_NAMES = {
		...
		"ANDOP", "OROP", "ULOP", "RELOP", "EQUALOP", "NEWLINE", "NUMLITERAL", 
		"COORDLIT", "StringLiteral", "UnterminatedStringLiteral", "IDENT", "LPAREN", 
		"RPAREN", "WHITESPACE", "LINECOMMENT"
	};
	...
	public final MethodcContext methodc() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << TRUE) | (1L << FALSE) | (1L << ULOP) | (1L << NUMLITERAL) | (1L << StringLiteral) | (1L << IDENT) | (1L << LPAREN))) != 0)) {
				{
				setState(100);
				args();
				}
	...
	public static class DclContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EduCodeListener ) ((EduCodeListener)listener).enterDcl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EduCodeListener ) ((EduCodeListener)listener).exitDcl(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EduCodeVisitor ) return ((EduCodeVisitor<? extends T>)visitor).visitDcl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class EqexprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EduCodeListener ) ((EduCodeListener)listener).enterEqexpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EduCodeListener ) ((EduCodeListener)listener).exitEqexpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EduCodeVisitor ) return ((EduCodeVisitor<? extends T>)visitor).visitEqexpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class RelexprContext extends ParserRuleContext {
		public List<AritexprContext> aritexpr() {
			return getRuleContexts(AritexprContext.class);
		}
		public AritexprContext aritexpr(int i) {
			return getRuleContext(AritexprContext.class,i);
		}
	...
	public static class AritexprContext extends ParserRuleContext {
		public TermContext term() {
			return getRuleContext(TermContext.class,0);
		}
		public AritexprContext aritexpr() {
			return getRuleContext(AritexprContext.class,0);
		}
		public TerminalNode ADDOP() { return getToken(EduCodeParser.ADDOP, 0); }
		public AritexprContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_aritexpr; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EduCodeListener ) ((EduCodeListener)listener).enterAritexpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EduCodeListener ) ((EduCodeListener)listener).exitAritexpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EduCodeVisitor ) return ((EduCodeVisitor<? extends T>)visitor).visitAritexpr(this);
			else return visitor.visitChildren(this);
		}
	}

	public final AritexprContext aritexpr() throws RecognitionException {
		return aritexpr(0);
	}

	private AritexprContext aritexpr(int _p) throws RecognitionException {
		ParserRuleContext _parentctx = _ctx;
		int _parentState = getState();
		AritexprContext _localctx = new AritexprContext(_ctx, _parentState);
		AritexprContext _prevctx = _localctx;
		int _startState = 42;
		enterRecursionRule(_localctx, 42, RULE_aritexpr, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					{
					{
					_localctx = new AritexprContext(_parentctx, _parentState);
					pushNewRecursionContext(_localctx, _startState, RULE_aritexpr);
					setState(271);
	...
	public static class LiteralContext extends ParserRuleContext {
		...
		public TerminalNode NUMLITERAL() { return getToken(EduCodeParser.NUMLITERAL, 0); }
		public TerminalNode StringLiteral() { return getToken(EduCodeParser.StringLiteral, 0); }
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		...
		case 21:
			return aritexpr_sempred((AritexprContext)_localctx, predIndex);
		case 22:
	...
	private boolean aritexpr_sempred(AritexprContext _localctx, int predIndex) {
		switch (predIndex) {
		case 2:
